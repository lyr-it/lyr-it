...
/*                                                      ISO_3166-1
Reino Unido le está oficialmente asignado el código alfa-2 GB en lugar de UK, sobre la base de su nombre oficial Reino Unido
...
$(document).ready(function () {
  const myCountry = $('input#country').attr('value');
  allCountries.forEach((elem)=>{
    if(Object.keys(elem) == myCountry) $('input#country').attr("value",Object.keys(elem)+"-"+Object.values(elem))
  })
});